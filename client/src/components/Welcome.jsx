...
//           </p> */}
//            <div className=" flex flex-1  flex-col container mx-auto px-4 md:px-6 items-center text-center justify-center space-y-6">
//           {/* <div variant="outline" className="bg-green-100 text-green-700">
//             Split expenses. Simplify life.
//           </div> */}

//           <h1 className="gradient-title mx-auto max-w-6xl text-4xl font-bold md:text-8xl text-amber-50">
...
//         <div className="flex flex-row flex-start flex-1 items-center justify-between w-full mf:mt-0 mt-10"> 
//           <div className=" flex flex-col mt-10 gap-x-2 ">
//  <div className=" flex flex-col-reverse lg:flex-col items-center justify-center w-full min-h-screen  
//  gap-2 px-4 lg:px-16 py-4">
...
//               <div className=" grid  max-w-sm  grid-cols-1 gap-12 lg:gap-4 items-center w-[600px]  sm:max-w-md md:max-w">
// <h2 className="text-white text-2xl sm:text-3xl font-semibold mb-4 text-center mt-6">
// Your Account
// </h2>
//               <motion.div
...
//                 <div className="absolute F-bottom-8 -right-8 w-64 h-64 bg-white/5 rounded-full filter blur-3xl"></div>
//               </div>
...
<div className="flex flex-col w-full px-4 sm:px-6 md:px-10">
  ...
  <div className="flex flex-col-reverse items-center justify-between py-10 gap-10">
    ...
    <div className="w-full max-w-4xl mx-auto">
     ...
     <div className="flex flex-col text-center lg:text-left items-center lg:items-start space-y-6 max-w-3xl mx-auto">
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-amber-50">
        The smartest way to split expenses with friends
      </h1>
      ...
      {!currentAccount && (
        <button
          type="button"
          onClick={connectWallet}
          className="flex items-center gap-2 bg-[#2952e3] hover:bg-[#2546bd] text-white px-6 py-3 rounded-full text-base font-semibold"
        >
